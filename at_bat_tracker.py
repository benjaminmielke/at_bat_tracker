...
# =============================================================================
def get_bigquery_client():import streamlit as st
from streamlit_image_coordinates import streamlit_image_coordinates
import matplotlib.pyplot as plt
from matplotlib.lines import Line2D
from PIL import Image
...
if st.session_state["stage"] == "game_details":
    ...
    if None not in (hard_hit, weak_hit, fly, line, ground):
        # The LaTeX array with aligned columns.
        metrics_text = (
            r"$\begin{array}{ccccc}"
        ...
        # Place the array a bit below the title (adjust the y coordinate as needed).
