...
if st.session_state["stage"] == "game_details":
    ...
    if hard_hit is not None and weak_hit is not None:
        ...
        ax.text(0.5, 0.86, label_line, transform=ax.transAxes, ha='center', fontsize=8, color='black')
        ax.text(0.5, 0.82, value_line, transform=ax.transAxes, ha='center', fontsize=8, color='black')
